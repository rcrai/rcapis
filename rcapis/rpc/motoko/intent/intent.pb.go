...
func (IntentView) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0}
}
...
func (Intent_WebhookState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 0}
}
...
func (Intent_TrainingPhrase_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 0, 0}
}
...
func (Intent_Message_Platform) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 0}
}
...
type Intent struct {
	...
	WebhookState Intent_WebhookState `protobuf:"varint,6,opt,name=webhook_state,json=webhookState,proto3,enum=rcrai.rpc.motoko.Intent_WebhookState" json:"webhook_state,omitempty"`
	...
	OutputContexts []*context.Context `protobuf:"bytes,11,rep,name=output_contexts,json=outputContexts,proto3" json:"output_contexts,omitempty"`
	...
	DefaultResponsePlatforms []Intent_Message_Platform `protobuf:"varint,15,rep,packed,name=default_response_platforms,json=defaultResponsePlatforms,proto3,enum=rcrai.rpc.motoko.Intent_Message_Platform" json:"default_response_platforms,omitempty"`
...
func (m *Intent) GetOutputContexts() []*context.Context {
	if m != nil {
...
type Intent_TrainingPhrase struct {
	...
	Type Intent_TrainingPhrase_Type `protobuf:"varint,2,opt,name=type,proto3,enum=rcrai.rpc.motoko.Intent_TrainingPhrase_Type" json:"type,omitempty"`
...
func (*Intent_Parameter) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 1}
}
...
type Intent_Message struct {
	...
	Platform             Intent_Message_Platform `protobuf:"varint,6,opt,name=platform,proto3,enum=rcrai.rpc.motoko.Intent_Message_Platform" json:"platform,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (*Intent_Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2}
}
...
func (*Intent_Message_Image) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 1}
}
...
func (*Intent_Message_QuickReplies) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 2}
}
...
func (*Intent_Message_Card) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 3}
}
...
func (*Intent_Message_Card_Button) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 3, 0}
}
...
func (*Intent_Message_SimpleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 4}
}
...
func (*Intent_Message_SimpleResponses) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 5}
}
...
func (*Intent_Message_BasicCard) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 6}
}
...
func (*Intent_Message_BasicCard_Button) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 6, 0}
}
...
func (*Intent_Message_BasicCard_Button_OpenUriAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 6, 0, 0}
}
...
func (*Intent_Message_Suggestion) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 7}
}
...
func (*Intent_Message_Suggestions) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 8}
}
...
func (*Intent_Message_LinkOutSuggestion) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 9}
}
...
func (*Intent_Message_ListSelect) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 10}
}
...
func (*Intent_Message_ListSelect_Item) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 10, 0}
}
...
func (*Intent_Message_CarouselSelect) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 11}
}
...
func (*Intent_Message_CarouselSelect_Item) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 11, 0}
}
...
func (*Intent_Message_SelectItemInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 2, 12}
}
...
func (*Intent_FollowupIntentInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{0, 3}
}
...
type ListIntentsRequest struct {
	...
	IntentView IntentView `protobuf:"varint,3,opt,name=intent_view,json=intentView,proto3,enum=rcrai.rpc.motoko.IntentView" json:"intent_view,omitempty"`
...
func (*ListIntentsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{1}
}
...
func (*ListIntentsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{2}
}
...
func (*GetIntentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{3}
}
...
type CreateIntentRequest struct {
	...
	// Optional. The resource view to apply to the returned intent.
	IntentView           IntentView `protobuf:"varint,4,opt,name=intent_view,json=intentView,proto3,enum=rcrai.rpc.motoko.IntentView" json:"intent_view,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*CreateIntentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{4}
}
...
func (*UpdateIntentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{5}
}
...
func (*DeleteIntentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{6}
}
...
type BatchUpdateIntentsRequest struct {
	...
	// Optional. The resource view to apply to the returned intent.
	IntentView           IntentView `protobuf:"varint,6,opt,name=intent_view,json=intentView,proto3,enum=rcrai.rpc.motoko.IntentView" json:"intent_view,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*BatchUpdateIntentsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{7}
}
...
func (*BatchUpdateIntentsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{8}
}
...
func (*BatchDeleteIntentsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{9}
}
...
func (*IntentBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f99bf02e8d36684, []int{10}
}
...
func init() {
	proto.RegisterEnum("rcrai.rpc.motoko.IntentView", IntentView_name, IntentView_value)
	proto.RegisterEnum("rcrai.rpc.motoko.Intent_WebhookState", Intent_WebhookState_name, Intent_WebhookState_value)
	proto.RegisterEnum("rcrai.rpc.motoko.Intent_TrainingPhrase_Type", Intent_TrainingPhrase_Type_name, Intent_TrainingPhrase_Type_value)
	proto.RegisterEnum("rcrai.rpc.motoko.Intent_Message_Platform", Intent_Message_Platform_name, Intent_Message_Platform_value)
	proto.RegisterType((*Intent)(nil), "rcrai.rpc.motoko.Intent")
	proto.RegisterType((*Intent_TrainingPhrase)(nil), "rcrai.rpc.motoko.Intent.TrainingPhrase")
	proto.RegisterType((*Intent_TrainingPhrase_Part)(nil), "rcrai.rpc.motoko.Intent.TrainingPhrase.Part")
	proto.RegisterType((*Intent_Parameter)(nil), "rcrai.rpc.motoko.Intent.Parameter")
	proto.RegisterType((*Intent_Message)(nil), "rcrai.rpc.motoko.Intent.Message")
	proto.RegisterType((*Intent_Message_Text)(nil), "rcrai.rpc.motoko.Intent.Message.Text")
	proto.RegisterType((*Intent_Message_Image)(nil), "rcrai.rpc.motoko.Intent.Message.Image")
	proto.RegisterType((*Intent_Message_QuickReplies)(nil), "rcrai.rpc.motoko.Intent.Message.QuickReplies")
	proto.RegisterType((*Intent_Message_Card)(nil), "rcrai.rpc.motoko.Intent.Message.Card")
	proto.RegisterType((*Intent_Message_Card_Button)(nil), "rcrai.rpc.motoko.Intent.Message.Card.Button")
	proto.RegisterType((*Intent_Message_SimpleResponse)(nil), "rcrai.rpc.motoko.Intent.Message.SimpleResponse")
	proto.RegisterType((*Intent_Message_SimpleResponses)(nil), "rcrai.rpc.motoko.Intent.Message.SimpleResponses")
	proto.RegisterType((*Intent_Message_BasicCard)(nil), "rcrai.rpc.motoko.Intent.Message.BasicCard")
	proto.RegisterType((*Intent_Message_BasicCard_Button)(nil), "rcrai.rpc.motoko.Intent.Message.BasicCard.Button")
	proto.RegisterType((*Intent_Message_BasicCard_Button_OpenUriAction)(nil), "rcrai.rpc.motoko.Intent.Message.BasicCard.Button.OpenUriAction")
	proto.RegisterType((*Intent_Message_Suggestion)(nil), "rcrai.rpc.motoko.Intent.Message.Suggestion")
	proto.RegisterType((*Intent_Message_Suggestions)(nil), "rcrai.rpc.motoko.Intent.Message.Suggestions")
	proto.RegisterType((*Intent_Message_LinkOutSuggestion)(nil), "rcrai.rpc.motoko.Intent.Message.LinkOutSuggestion")
	proto.RegisterType((*Intent_Message_ListSelect)(nil), "rcrai.rpc.motoko.Intent.Message.ListSelect")
	proto.RegisterType((*Intent_Message_ListSelect_Item)(nil), "rcrai.rpc.motoko.Intent.Message.ListSelect.Item")
	proto.RegisterType((*Intent_Message_CarouselSelect)(nil), "rcrai.rpc.motoko.Intent.Message.CarouselSelect")
	proto.RegisterType((*Intent_Message_CarouselSelect_Item)(nil), "rcrai.rpc.motoko.Intent.Message.CarouselSelect.Item")
	proto.RegisterType((*Intent_Message_SelectItemInfo)(nil), "rcrai.rpc.motoko.Intent.Message.SelectItemInfo")
	proto.RegisterType((*Intent_FollowupIntentInfo)(nil), "rcrai.rpc.motoko.Intent.FollowupIntentInfo")
	proto.RegisterType((*ListIntentsRequest)(nil), "rcrai.rpc.motoko.ListIntentsRequest")
	proto.RegisterType((*ListIntentsResponse)(nil), "rcrai.rpc.motoko.ListIntentsResponse")
	proto.RegisterType((*GetIntentRequest)(nil), "rcrai.rpc.motoko.GetIntentRequest")
	proto.RegisterType((*CreateIntentRequest)(nil), "rcrai.rpc.motoko.CreateIntentRequest")
	proto.RegisterType((*UpdateIntentRequest)(nil), "rcrai.rpc.motoko.UpdateIntentRequest")
	proto.RegisterType((*DeleteIntentRequest)(nil), "rcrai.rpc.motoko.DeleteIntentRequest")
	proto.RegisterType((*BatchUpdateIntentsRequest)(nil), "rcrai.rpc.motoko.BatchUpdateIntentsRequest")
	proto.RegisterType((*BatchUpdateIntentsResponse)(nil), "rcrai.rpc.motoko.BatchUpdateIntentsResponse")
	proto.RegisterType((*BatchDeleteIntentsRequest)(nil), "rcrai.rpc.motoko.BatchDeleteIntentsRequest")
	proto.RegisterType((*IntentBatch)(nil), "rcrai.rpc.motoko.IntentBatch")
}

func init() { proto.RegisterFile("rcapis/rpc/motoko/intent.proto", fileDescriptor_0f99bf02e8d36684) }

var fileDescriptor_0f99bf02e8d36684 = []byte{
	...
	,
}
...
type IntentsClient interface {
	...
	ListIntents(ctx context1.Context, in *ListIntentsRequest, opts ...grpc.CallOption) (*ListIntentsResponse, error)
	// Retrieves the specified intent.
	GetIntent(ctx context1.Context, in *GetIntentRequest, opts ...grpc.CallOption) (*Intent, error)
	// Creates an intent in the specified agent.
	CreateIntent(ctx context1.Context, in *CreateIntentRequest, opts ...grpc.CallOption) (*Intent, error)
	// Updates the specified intent.
	UpdateIntent(ctx context1.Context, in *UpdateIntentRequest, opts ...grpc.CallOption) (*Intent, error)
	// Deletes the specified intent.
	DeleteIntent(ctx context1.Context, in *DeleteIntentRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// Updates/Creates multiple intents in the specified agent.
	//
	// Operation<response: BatchUpdateIntentsResponse>
	BatchUpdateIntents(ctx context1.Context, in *BatchUpdateIntentsRequest, opts ...grpc.CallOption) (*longrunning.Operation, error)
	// Deletes intents in the specified agent.
	//
	// Operation<response: google.protobuf.Empty>
	BatchDeleteIntents(ctx context1.Context, in *BatchDeleteIntentsRequest, opts ...grpc.CallOption) (*longrunning.Operation, error)
}
...
func (c *intentsClient) ListIntents(ctx context1.Context, in *ListIntentsRequest, opts ...grpc.CallOption) (*ListIntentsResponse, error) {
	out := new(ListIntentsResponse)
	err := c.cc.Invoke(ctx, "/rcrai.rpc.motoko.Intents/ListIntents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intentsClient) GetIntent(ctx context1.Context, in *GetIntentRequest, opts ...grpc.CallOption) (*Intent, error) {
	out := new(Intent)
	err := c.cc.Invoke(ctx, "/rcrai.rpc.motoko.Intents/GetIntent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intentsClient) CreateIntent(ctx context1.Context, in *CreateIntentRequest, opts ...grpc.CallOption) (*Intent, error) {
	out := new(Intent)
	err := c.cc.Invoke(ctx, "/rcrai.rpc.motoko.Intents/CreateIntent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intentsClient) UpdateIntent(ctx context1.Context, in *UpdateIntentRequest, opts ...grpc.CallOption) (*Intent, error) {
	out := new(Intent)
	err := c.cc.Invoke(ctx, "/rcrai.rpc.motoko.Intents/UpdateIntent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intentsClient) DeleteIntent(ctx context1.Context, in *DeleteIntentRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/rcrai.rpc.motoko.Intents/DeleteIntent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intentsClient) BatchUpdateIntents(ctx context1.Context, in *BatchUpdateIntentsRequest, opts ...grpc.CallOption) (*longrunning.Operation, error) {
	out := new(longrunning.Operation)
	err := c.cc.Invoke(ctx, "/rcrai.rpc.motoko.Intents/BatchUpdateIntents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intentsClient) BatchDeleteIntents(ctx context1.Context, in *BatchDeleteIntentsRequest, opts ...grpc.CallOption) (*longrunning.Operation, error) {
	out := new(longrunning.Operation)
	err := c.cc.Invoke(ctx, "/rcrai.rpc.motoko.Intents/BatchDeleteIntents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IntentsServer interface {
	// Returns the list of all intents in the specified agent.
	ListIntents(context1.Context, *ListIntentsRequest) (*ListIntentsResponse, error)
	// Retrieves the specified intent.
	GetIntent(context1.Context, *GetIntentRequest) (*Intent, error)
	// Creates an intent in the specified agent.
	CreateIntent(context1.Context, *CreateIntentRequest) (*Intent, error)
	// Updates the specified intent.
	UpdateIntent(context1.Context, *UpdateIntentRequest) (*Intent, error)
	// Deletes the specified intent.
	DeleteIntent(context1.Context, *DeleteIntentRequest) (*empty.Empty, error)
	// Updates/Creates multiple intents in the specified agent.
	//
	// Operation<response: BatchUpdateIntentsResponse>
	BatchUpdateIntents(context1.Context, *BatchUpdateIntentsRequest) (*longrunning.Operation, error)
	// Deletes intents in the specified agent.
	//
	// Operation<response: google.protobuf.Empty>
	BatchDeleteIntents(context1.Context, *BatchDeleteIntentsRequest) (*longrunning.Operation, error)
}
...
func _Intents_ListIntents_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rcrai.rpc.motoko.Intents/ListIntents",
	}
...
func _Intents_GetIntent_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rcrai.rpc.motoko.Intents/GetIntent",
	}
	handler := func(ctx context1.Context, req interface{}) (interface{}, error) {
...
func _Intents_CreateIntent_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rcrai.rpc.motoko.Intents/CreateIntent",
	}
	handler := func(ctx context1.Context, req interface{}) (interface{}, error) {
...
func _Intents_UpdateIntent_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rcrai.rpc.motoko.Intents/UpdateIntent",
	}
	handler := func(ctx context1.Context, req interface{}) (interface{}, error) {
...
func _Intents_DeleteIntent_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rcrai.rpc.motoko.Intents/DeleteIntent",
	}
	handler := func(ctx context1.Context, req interface{}) (interface{}, error) {
...
func _Intents_BatchUpdateIntents_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rcrai.rpc.motoko.Intents/BatchUpdateIntents",
	}
	handler := func(ctx context1.Context, req interface{}) (interface{}, error) {
...
func _Intents_BatchDeleteIntents_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rcrai.rpc.motoko.Intents/BatchDeleteIntents",
	}
	handler := func(ctx context1.Context, req interface{}) (interface{}, error) {
...
var _Intents_serviceDesc = grpc.ServiceDesc{
	ServiceName: "rcrai.rpc.motoko.Intents",
	...
	Metadata: "rcapis/rpc/motoko/intent.proto",
}
